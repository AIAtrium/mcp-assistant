...
import arcade_exa
from arcade_exa.tools.hello import say_hello
...
catalog = ToolCatalog()
catalog.add_module(arcade_exa)


@tool_eval()
def exa_eval_suite() -> EvalSuite:
    suite = EvalSuite(
        name="exa Tools Evaluation",
        system_message=(
            "You are an AI assistant with access to exa tools. "
